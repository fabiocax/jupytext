...
SAMPLES = [('r', ('R', {})),
           ...
           ('r plot_1, bool=TRUE, fig.path="fig_path/"', ('R', {
               'name':
               'plot_1',
               'bool':
               True,
           ...
           ('python echo=if a==5 then TRUE else FALSE', ('python', {
               'echo':
               '#R_CODE#if a==5 then TRUE else FALSE'
           })),
           ...
           ('python active="ipynb,py"', ('python', {
               'active': 'ipynb,py'
           })),
           ('python include=FALSE, active="Rmd"', ('python', {
               'active': 'Rmd',
               'tags': ['remove_cell']
           })),
           ('r chunk_name, include=FALSE, active="Rmd"', ('R', {
               'name':
               'chunk_name',
               'active':
               'Rmd',
           ...
           ('python tags=c("parameters")', ('python', {
               'tags': ['parameters']
           }))]
